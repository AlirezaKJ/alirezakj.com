<section id="education" class="min-h-screen bg-background py-16 md:py-20 lg:py-32">
	<div class="mx-auto w-7xl max-w-[var(--keyw)] px-4 md:px-0">
		<!-- Section Header -->
		<div class="mb-16 md:mb-24 text-center">
			<h2 class="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-primary-950 lg:text-6xl xl:text-7xl">
		...
		<div class="mb-12 md:mb-20">
			<h3 class="mb-8 md:mb-12 flex items-center gap-3 text-xl sm:text-2xl font-bold text-primary-900 md:text-3xl">
				<span class="flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-accent-100">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 fill-accent-600" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M840-288v-276L480-384 48-600l432-216 432 216v312h-72ZM480-144 216-276v-159l264 132 264-132v159L480-144Z"/></svg>
			...
			<div class="space-y-4 md:space-y-6">
				<!-- Current Education -->
				<div class="group relative overflow-hidden rounded-2xl bg-secondary-100 p-6 md:p-8 lg:p-10 shadow-lg transition-all duration-300 hover:shadow-2xl">
					<div class="absolute left-0 top-0 h-1 w-full bg-gradient-to-r from-accent-500 via-secondary-500 to-accent-400"></div>

					<div class="mb-4 md:mb-6 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
						<div class="flex-1">
							<h4 class="text-xl sm:text-2xl md:text-3xl font-bold text-primary-900">Swinburne University of Technology</h4>
							<p class="mt-1 text-xs sm:text-sm font-medium text-secondary-600">Melbourne, Australia</p>
						</div>
						<span class="inline-flex items-center gap-2 rounded-full bg-accent-200 px-4 py-2 text-xs font-semibold text-accent-700 md:text-sm">
							<span class="h-2 w-2 rounded-full bg-accent-500 animate-pulse"></span>
							Current
						</span>
					</div>

					<p class="mb-3 md:mb-4 text-xs sm:text-sm font-medium text-primary-600">Certificate IV in Cyber Security • 2025 - 2026</p>
					<p class="leading-relaxed text-primary-700 text-sm sm:text-base">
						Focusing on Information Technology, Cybersecurity fundamentals, and General Education. Building a strong foundation in computer science principles and advanced IT concepts.
					</p>
				</div>
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-secondary-100 p-6 md:p-8 lg:p-10 shadow-lg transition-all duration-300 hover:shadow-2xl">
					...
					<p class="mb-3 md:mb-4 text-xs sm:text-sm font-medium text-primary-600">Certificate III in Information Technology • 2025</p>
					<p class="leading-relaxed text-primary-700 text-sm sm:text-base">
						Focusing on Information Technology, Cybersecurity fundamentals, and General Education. Building a strong foundation in computer science principles and advanced IT concepts.
					</p>
				</div>
        ...
        <div class="group relative overflow-hidden rounded-2xl bg-secondary-100 p-6 md:p-8 lg:p-10 shadow-lg transition-all duration-300 hover:shadow-2xl">
					...
					<div class="mb-4 md:mb-6 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
						<div class="flex-1">
							<h4 class="text-xl sm:text-2xl md:text-3xl font-bold text-primary-900">Bundoora Secondary College</h4>
							<p class="mt-1 text-xs sm:text-sm font-medium text-secondary-600">Melbourne, Australia</p>
						</div>
						<span class="inline-flex items-center rounded-full bg-accent-200 px-4 py-2 text-xs font-semibold text-primary-700 md:text-sm">
							VCE / Diploma
					...
					<p class="mb-3 md:mb-4 text-xs sm:text-sm font-medium text-primary-600">Year 11-12 • 2023 - 2024</p>
					<!-- <p class="leading-relaxed text-primary-700">
            Progressed from foundational IT knowledge to advanced technical skills, including web development, cybersecurity practices, and software engineering principles. Developed proficiency in multiple programming languages and frameworks while maintaining strong academic performance across core subjects.
					</p> -->
				</div>
		...
		<div>
			<h3 class="mb-8 md:mb-12 flex items-center gap-3 text-xl sm:text-2xl font-bold text-primary-900 md:text-3xl">
				<span class="flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-accent-100">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 fill-accent-600" viewBox="0 -960 960 960"><path d="M160-880h640q33 0 56.5 23.5T880-800v440q0 33-23.5 56.5T800-280H640v200l-160-80-160 80v-200H160q-33 0-56.5-23.5T80-360v-440q0-33 23.5-56.5T160-880Zm0 440h640v-120H160v120Z"/></svg>
