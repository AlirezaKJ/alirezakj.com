...
<nav class="flex justify-end items-center w-full h-36 px-6 z-1">
  <div class={`transition-all duration-500 fixed top-0 z-1 ${ontop || expandBottom || menuOpen  ? 'left-30' : 'left-6'} z-50`} style={onbottom ? 'top: calc(100vh - 10.5rem);' : ''}> <!-- 6 (24) + 12 (48) + 12 (48) = 120 -->
